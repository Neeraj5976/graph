...
int main() {
	...
	unordered_set<unordered_set<int>*> *stronglyCompo=getComponent(edges,edgesT,n);
	unordered_set<unordered_set<int>*>::iterator it=stronglyCompo->begin();
	while(it!=stronglyCompo->end()){
